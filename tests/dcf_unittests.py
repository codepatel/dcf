...
class DCFUnitTest(unittest.TestCase):
    ...
    def testwithDCFinputs(self):
        ...
        self.assertAlmostEqual(self.result[1]['estimated_value_per_share'], 56.31, delta=0.01)
        ...
        self.assertAlmostEqual(self.result[1]['estimated_value_per_share'], 64.95, delta=0.01)